...
public class CartListAdaptor extends BaseAdapter {
  ...
  //  ArrayList<User> Contact=new ArrayList<>();
    ...
    String pr_id;
    ImageView delete;
    public CartListAdaptor(FragmentActivity activity, ArrayList<CartPojo> storeContacts) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        view = mInflater.inflate(R.layout.cart_adapter, null);
        griddetail_text = (TextView) view.findViewById(R.id.product_name);
        mgridimage=(ImageView) view.findViewById(R.id.thumbnail);
        price = (TextView) view.findViewById(R.id.product_price);
        quantity=(TextView)view.findViewById(R.id.product_qty);
        delete=(ImageView)view.findViewById(R.id.delete);
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pr_id =  promotionDetailses.get(i).getP_id();
                userid =  promotionDetailses.get(i).getU_id();
                new RemoveToCard().execute();
            }
        });
        ...
        if(promotionDetailses.get(i).getUnit_price()!=null){
            ...
            price.setText("$ "+String.valueOf(totalPrice)+".00");
        }else {
            price.setText(" ");
        }
